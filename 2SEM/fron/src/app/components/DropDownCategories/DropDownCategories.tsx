...
const DropDownCategories: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={toggleMenu}
        className="px-4 py-2 bg-blue-500 text-white rounded flex items-center cursor-pointer"
      >
        Categorias
        ...
        <>
          <div className="absolute bg-white shadow-lg rounded mt-2 p-4 w-48">
            <ul>
              ...
              <li className="py-2">
                <Link className="font-bold text-black px-2 hover:underline" href="/categoria/pratos-principais">Pratos 
                </Link>
              </li>
            </ul>
          </div>
