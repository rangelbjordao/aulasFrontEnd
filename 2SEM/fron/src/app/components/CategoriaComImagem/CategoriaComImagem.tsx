...
export default function CategoriasComImagem() {
    ...
    return (
        <div className="min-h-screen p-4">
            <div className="bg-blue-950 max-w-[700px] w-auto mx-auto  flex flex-col text-amber-50 items-center space-y-8 py-10 m-5 rounded-lg">
        ...
        com o object, e dps eu mapeio cada elemento q tem no object, em uma var "cat"*/}
                        {Object.keys(imagens).map((cat) => (
                            ...
                            <li key={cat}>
                                <button
                                    ...
                                    className={`font-bold underline ${categoriaSelecionada === cat ? "text-yellow-400" : "text-white"
                                        }`}
                                >
                ...
                <Link href={rotas[categoriaSelecionada]}>
                    <button className="w-72 mt-4 px-6 py-2 bg-yellow-500 text-blue-900 font-semibold rounded hover:bg-yellow-400 transition-all">
